...
df.loc[0] = ['Gradient Descent', 'x^2 + y^2', f'{learning_rate_const}', f'({x0}, {y0})', f'({x_opt1[-1]}, {y_opt1[-1]})', f1(x_opt1[-1], y_opt1[-1]), num_iterations1, execution_time1]
df.loc[1] = ['Gradient Descent', 'x^2 + 100 * y^2', f'{learning_rate_const}', f'({x0}, {y0})', f'({x_opt2[-1]}, {y_opt2[-1]})', f2(x_opt2[-1], y_opt2[-1]), num_iterations2, execution_time2]
...
df.loc[2] = ['Gradient Descent', 'x^2 + y^2', 'Golden section search', f'({x0}, {y0})', f'({x_opt1[-1]}, {y_opt1[-1]})', f1(x_opt1[-1], y_opt1[-1]), num_iterations1, execution_time1]
df.loc[3] = ['Gradient Descent', 'x^2 + 100 * y^2', 'Golden section search', f'({x0}, {y0})', f'({x_opt2[-1]}, {y_opt2[-1]})', f2(x_opt2[-1], y_opt2[-1]), num_iterations2, execution_time2]
...
df.loc[4] = ['Scipy Minimize', 'x^2 + y^2', 'Nelder-Mead', f'({x0}, {y0})', f'({res1.x[0]}, {res1.x[1]})', f1(res1.x[0], res1.x[1]), res1.nit, res1.nfev]
df.loc[5] = ['Scipy Minimize', 'x^2 + 1000 * y^2', 'Nelder-Mead', f'({x0}, {y0})', f'({res2.x[0]}, {res2.x[1]})', f2(res2.x[0], res2.x[1]), res2.nit, res2.nfev]
...
df.loc[6] = ['Coordinate Descent', 'x^2 + y^2', 'Golden section search', f'({x0}, {y0})', f'({x_opt1}, {y_opt1})', f1(x_opt1, y_opt1), num_iterations1, execution_time1]
df.loc[7] = ['Coordinate Descent', 'x^2 + 1000 * y^2', 'Golden section search', f'({x0}, {y0})', f'({x_opt2}, {y_opt2})', f2(x_opt2, y_opt2), num_iterations2, execution_time2]
